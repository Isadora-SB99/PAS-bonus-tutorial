package br.com.padarqsis.layerbasedapplic.message;

import br.com.padarqsis.layerbasedapplic.config.RabbitMQConfig;
...
public class MessageProducer {
    ...
    public void sendMessageToQueue1(String message) {
        ...
        System.out.println("Mensagem enviada para a Fila 1: " +
                message);
    }
    ...
    public void sendMessageToQueue2(String message) {
        ...
        System.out.println("Mensagem enviada para a Fila 2: " +
                message);
    }
}
